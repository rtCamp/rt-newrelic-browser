=== New Relic Browser ===
Contributors: rtcamp,prasad,rakshit,rohanveer
Requires at least: 3.0.1
Tested up to: 4.0.1
License: GPLv2 or later
License URI: http://www.gnu.org/licenses/gpl-2.0.html

This plugin helps you to create a New Relic Browser application.
...
Activate \"New Relic Browser\" in the \"Plugins\" admin panel using the \"Activate\" link. If you\'re using WordPress Multisite, you can choose to activate \"New Relic Browser\" network wide for full integration with all of your site.